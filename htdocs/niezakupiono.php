...
header("Cache-Control: no-store, no-cache, must-revalidate");  
    ...
    if(!isset($_COOKIE['buyfail']))
    {
        header('Location: index.php');
    }
    else
    {
        setcookie("buyfail",null,time()-1);
        unset($_COOKIE['buyfail']);
    }
    if(isset($_COOKIE['id']))
    {
...
<div id="cookies" style="line-height: normal; visibility:hidden;">
        ...
        <div id="content">
            <span class="bigtitle">PORAŻKA!</span>
            
            <div class="dottedline"></div>
            
            Zakup zakończony niepowodzeniem : Niewystarczające środki na koncie!!!
        </div>  
