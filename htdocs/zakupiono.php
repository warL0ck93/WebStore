...
header("Cache-Control: no-store, no-cache, must-revalidate");  
    ...
    if(!isset($_COOKIE['buycorr']))
    {
        header('Location: index.php');
    }
    else
    {
        setcookie("buycorr",null,time()-1);
        unset($_COOKIE['buycorr']);
    }
    if(isset($_COOKIE['id']))
    {
...
<div id="cookies" style="line-height: normal; visibility:hidden;">
        ...
        <div id="content">
            <span class="bigtitle">SUKCES!</span>
            
            <div class="dottedline"></div>
            
            Gratulacje zakup zakończony sukcesem kod aktywacyjny do swojej gry znajdziesz w<a href = "konto.php" style="color:blue;"> panelu użytkownika</a>
        </div>  
