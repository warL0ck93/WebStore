...
header("Cache-Control: no-store, no-cache, must-revalidate");  
    ...
    {
        if($log_res = @$connection->query(sprintf("INSERT INTO Kraj (nazwa_kraj) VALUES ('%s')", mysqli_real_escape_string($connection,$_POST['nazwa']))))
        {
...
<?php
        ...
        <div id="content">
            <span class="bigtitle">NOWY KRAJ</span>
            
            <div class="dottedline"></div>
            <form action="newkraj.php" method = "post">
        Nowy Kraj: <input type="text" name="nazwa" text="Wpisz wyszukiwaną fraze"/></br> 
