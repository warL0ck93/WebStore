...
<div id="cookies" style="line-height: normal; visibility:hidden;">
        ...
        <div id="sidebar">
            ...
            $adminCheck= @$connection->query(sprintf("SELECT * FROM Uzytkownicy Where nazwa_uzytkownika ='%s'", mysqli_real_escape_string($connection,$_COOKIE['login'])))
            or die(" zepsuło się");

            $r=$adminCheck->fetch_assoc();
            if($r['Stat']=="Admin")
            {
                echo '<div class="optionL"><a href="Ugames.php">DODAJ GRĘ</a></div>
                <div class="optionL"><a href="Ugames.php">DODAJ PRODUCENTA</a></div>
                <div class="optionL"><a href="Ugames.php">DODAJ GATUNEK</a></div>
                <div class="optionL"><a href="Ugames.php">DODAJ KRAJ</a></div>';
            }
        ...
        <div id="content">
            <span class="bigtitle">PANEL UŻYTKOWNIKA</span>
